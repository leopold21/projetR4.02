...
public class Revenu {
    /**
     *
     *  Calculates the household's reference tax income
     *  based on the net income declared by the members of the tax household
     *  and the applicable tax allowance.
     *
     * @param paramRevenuNetDeclarant1 the net income declared
     * by the first person in the tax household
     * @param paramRevenuNetDeclarant2 net income declared
     * by the second person in the tax household
     * @param paramAbattement the deduction from total household income
     *
