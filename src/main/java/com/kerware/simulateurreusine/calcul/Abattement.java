...
public class Abattement {
    ...
    /**
     * Calculates the tax allowance based on family situation and
     * net income declared by members of the tax household.
     *
     ...
     * @param paramRevenuNetDeclarant2 the net income declared
